...
<form action="<?php $_PHP_SELF ?>" method="post">
        <h1 class="text-center" style="color:block; font-family: 'Holtwood One SC', serif;">LOGIN PAGE</h1>

        <p style="color:white;">Please fill your data here to this form and submit to login</p>
        ...
        <!---------------------------Need to be converted to form so we can use session -------------------------->
            ...
            <button class="btn btn-success mt-3 mb-3 form-control w-100" type="submit" name="submit"> LOGIN</button>
            <p style="color:white;">Are you a new user? <a href ="signup.php">Signup now</a> </p>
            </form>
